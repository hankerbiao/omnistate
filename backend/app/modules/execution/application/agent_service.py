...
class ExecutionAgentService:
    ...
    def _ensure_utc_datetime(dt: datetime | None) -> datetime | None:
        """确保 datetime 是 UTC aware，如果传入 None 则返回 None。"""
        if dt is None:
            return None
