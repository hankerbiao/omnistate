...
class ExecutionTaskQueryMixin:
    ...
    def _serialize_run_doc(run_doc: ExecutionTaskRunDoc) -> Dict[str, Any]:
        return {
            ...
            "stop_mode": getattr(run_doc, "stop_mode", "NONE"),
            "stop_requested_at": getattr(run_doc, "stop_requested_at", None),
            "stop_requested_by": getattr(run_doc, "stop_requested_by", None),
            "stop_reason": getattr(run_doc, "stop_reason", None),
