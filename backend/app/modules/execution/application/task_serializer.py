...
class ExecutionTaskSerializer:
    ...
    def serialize_task_doc(task_doc: ExecutionTaskDoc) -> Dict[str, Any]:
        ...
        return {
            ...
            "started_case_count": task_doc.started_case_count,
            "finished_case_count": task_doc.finished_case_count,
            "passed_case_count": task_doc.passed_case_count,
            ...
            "last_event_at": task_doc.last_event_at,
            "last_event_id": task_doc.last_event_id,
            "last_event_type": task_doc.last_event_type,
            "last_event_phase": task_doc.last_event_phase,
