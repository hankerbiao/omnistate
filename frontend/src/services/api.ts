...
class ApiClient {
  ...
  async getTaskTimeline(taskId: string, limit: number = 200): Promise<ApiResponse<TaskTimeline>> {
    return this.request<TaskTimeline>(`/execution/tasks/${taskId}/timeline?limit=${limit}`, {
      method: 'GET',
    });
  }
